...
<section className="max-w-6xl mx-auto mb-16 animate-fade-in" style={{ animationDelay: '280ms' }}>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
    ...
    {/* COLUMN 1: Basic Medical Sciences */}
    <div className="space-y-6">
      <Card className="overflow-hidden hover:shadow-lg transition-shadow border-t-4 border-t-primary h-full">
        <CardContent className="p-6">
          <h4 className="text-xl font-bold text-primary mb-4">Faculty of Basic Medical Sciences</h4>
          <div className="space-y-4">
            <div>
              <h5 className="font-semibold text-foreground">Department of Medicine and Surgery</h5>
              <p className="text-sm text-muted-foreground">• MBBS Medicine and Surgery</p>
            </div>
            <div>
    ...
    {/* COLUMN 2: Nursing and Clinical Sciences stacked */}
    <div className="flex flex-col gap-6">
      ...
      <Card className="overflow-hidden hover:shadow-lg transition-shadow border-t-4 border-t-primary">
        <CardContent className="p-6">
          <h4 className="text-xl font-bold text-primary mb-4">Faculty of Clinical Sciences</h4>
          <div className="space-y-4">
            <div>
              <h5 className="font-semibold text-foreground">Department of Medicine and Surgery</h5>
              <p className="text-sm text-muted-foreground">• MBBS Medicine and Surgery</p>
